...
beforeAll(() => {
  // Create the mock matchMedia function
  ...
  return Promise.all([
    import('../mode-switcher.js'),
    import('../theme-switcher.js')
  ]).then(([modeModule, themeModule]) => {
    global.ModeSwitcher = modeModule.ModeSwitcher;
    global.modeSwitcher = modeModule.modeSwitcher;
    global.ThemeSwitcher = themeModule.ThemeSwitcher;
    global.themeSwitcher = themeModule.themeSwitcher;
  });
});
...
beforeAll(async () => {
  // Import the modules after setting up the mocks
  const [modeModule, themeModule] = await Promise.all([
    import('../mode-switcher.js'),
    import('../theme-switcher.js')
  ]);
  
  ModeSwitcher = modeModule.ModeSwitcher;
  modeSwitcher = modeModule.modeSwitcher;
  ThemeSwitcher = themeModule.ThemeSwitcher;
  themeSwitcher = themeModule.themeSwitcher;
});
...
beforeAll(() => {
  ...
  // Import ModeSwitcher and ThemeSwitcher after setting up the mocks
  return import('../mode-switcher.js').then(module => {
    global.ModeSwitcher = module.ModeSwitcher;
    global.modeSwitcher = module.modeSwitcher;
    return import('../theme-switcher.js');
  }).then(module => {
    global.ThemeSwitcher = module.ThemeSwitcher;
    global.themeSwitcher = module.themeSwitcher;
  });
});
